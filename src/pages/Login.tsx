            ...
            <div className="w-full xl:w-1/2 grid place-items-center px-6">
              <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
                ...
                <form>
                  <div className="mb-4">
                    ...
                    <div className="relative">
                      ...
                      <span className="absolute right-4 top-4">
                        <svg className="fill-brand-yellow" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <g opacity="0.5">
                            <path
                  ...
                  <div className="mb-5">
                    <input type="submit" value="Sign In" className="w-full cursor-pointer rounded-lg border p-4 font-bold transition hover:bg-brand-yellow hover:text-brand-grey" />
                  </div>
                </form>
              </div>
            </div>
