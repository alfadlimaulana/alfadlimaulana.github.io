    ...
    <header className="sticky top-0 flex w-full bg-black z-999 drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none">
      <div className="flex items-center justify-between flex-grow px-4 py-4 shadow-2 md:px-6 2xl:px-11">
        ...
        <div className="hidden sm:block">
          <form action="https://formbold.com/s/unique_form_id" method="POST">
            <div className="relative">
              ...
              <input type="text" placeholder="Type to search..." className="w-full pr-4 bg-transparent pl-9 focus:outline-none xl:w-125" />
            </div>
          </form>
        </div>
        ...
        <div className="flex items-center gap-3 2xsm:gap-7">
          <div className="relative">
            <a className="flex items-center gap-4" onClick={() => {setOpen((prev) => !prev)}}>
            ...
            <div className={`${!open && "hidden"} absolute right-0 mt-4 w-62.5 flex-col rounded-sm border border-stroke bg-brand-blue shadow-default`}>
